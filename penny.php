		       ...
		       <!-- | orderBy : 'cents' : true -->
		        ...
		        <img ng-show="post.image != ''" src="{{post.image}}" alt="image" width="500px"  />
		           ...
		           <div class="commentSection pb2 pt2">
					...
					<p ng-show="post.comments != 0" class="tc orange f4 center"><a href="" ng-click="displayComments(post, post.time)" class="orange hoverNone">Show all comments</a></p>
		       
	           <div id="comments" ng-show="yesComments+post.time">
